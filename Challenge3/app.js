...
// ===================== DATA =====================
const TIPS = [
  { icon: '🚲', text: 'Cycling or walking for trips under 2km instead of driving can save up to <strong>0.5t CO₂</strong> per year.', savings: '0.5t CO₂/yr' },
  { icon: '🌱', text: 'Switching to a plant-based diet one day a week can reduce your food emissions by <strong>15%</strong>.', savings: '0.3t CO₂/yr' },
  { icon: '💡', text: 'Replacing all light bulbs with LEDs cuts your home lighting energy use by <strong>75%</strong>.', savings: '0.1t CO₂/yr' },
  { icon: '✈️', text: 'Taking one fewer long-haul flight per year can reduce your footprint by <strong>1.5–3t CO₂</strong>.', savings: '1.5–3t CO₂/trip' },
  { icon: '🛍️', text: 'Buying second-hand clothing instead of new reduces fashion footprint by <strong>82%</strong>.', savings: '0.2t CO₂/yr' },
  { icon: '🏠', text: 'Lowering your thermostat by just 1°C can cut heating bills and emissions by <strong>10%</strong>.', savings: '0.15t CO₂/yr' },
  { icon: '🥩', text: 'Cutting beef consumption by half can save the equivalent of <strong>0.5t CO₂</strong> per year.', savings: '0.5t CO₂/yr' },
  { icon: '☀️', text: 'Installing solar panels can eliminate <strong>80–100%</strong> of your home electricity emissions.', savings: 'Up to 1.5t CO₂/yr' },
];

const ACTIONS = [
  { id: 'a1', category: 'transport', emoji: '🚲', title: 'Cycle or Walk Short Trips', desc: 'Replace car trips under 3km with cycling or walking. Great for your health too!', saving: '0.5t CO₂/yr', difficulty: 'easy', color: '#10b981' },
  { id: 'a2', category: 'transport', emoji: '🚌', title: 'Use Public Transport', desc: 'Swap one car journey per week for bus, metro, or train.', saving: '0.4t CO₂/yr', difficulty: 'easy', color: '#10b981' },
  { id: 'a3', category: 'transport', emoji: '⚡', title: 'Switch to Electric Vehicle', desc: 'EV ownership cuts transport emissions by up to 70% depending on your grid.', saving: '1.0t CO₂/yr', difficulty: 'hard', color: '#10b981' },
  { id: 'a4', category: 'transport', emoji: '🤝', title: 'Carpooling', desc: 'Share your commute with colleagues to halve per-person emissions.', saving: '0.35t CO₂/yr', difficulty: 'easy', color: '#10b981' },
  { id: 'a5', category: 'home', emoji: '💡', title: 'Switch to LED Bulbs', desc: 'Replace all incandescent bulbs. LEDs use 75% less energy and last 25x longer.', saving: '0.1t CO₂/yr', difficulty: 'easy', color: '#0891b2' },
  { id: 'a6', category: 'home', emoji: '🌡️', title: 'Lower Your Thermostat', desc: 'Reduce heating by 1°C in winter. Each degree saves ~10% on your heating bill.', saving: '0.15t CO₂/yr', difficulty: 'easy', color: '#0891b2' },
  { id: 'a7', category: 'home', emoji: '☀️', title: 'Install Solar Panels', desc: 'Generate your own clean energy. Can eliminate 80–100% of home electricity emissions.', saving: '1.5t CO₂/yr', difficulty: 'hard', color: '#0891b2' },
  { id: 'a8', category: 'home', emoji: '♻️', title: 'Green Energy Tariff', desc: 'Switch your electricity provider to 100% renewable. Takes 10 minutes online.', saving: '0.8t CO₂/yr', difficulty: 'medium', color: '#0891b2' },
  { id: 'a9', category: 'food', emoji: '🌱', title: 'Meat-Free Monday', desc: 'Skip meat one day per week. Beef has a carbon footprint 20x higher than beans.', saving: '0.3t CO₂/yr', difficulty: 'easy', color: '#34d399' },
  { id: 'a10', category: 'food', emoji: '🥗', title: 'Go Vegetarian', desc: 'A fully vegetarian diet saves about 0.5t CO₂/yr vs an average meat-eating diet.', saving: '0.5t CO₂/yr', difficulty: 'medium', color: '#34d399' },
  { id: 'a11', category: 'food', emoji: '🛒', title: 'Buy Local & Seasonal', desc: 'Local seasonal produce has far lower transport and refrigeration emissions.', saving: '0.15t CO₂/yr', difficulty: 'easy', color: '#34d399' },
  { id: 'a12', category: 'food', emoji: '🗑️', title: 'Reduce Food Waste', desc: 'Plan meals and store food properly. ~8% of global emissions come from food waste.', saving: '0.2t CO₂/yr', difficulty: 'easy', color: '#34d399' },
  { id: 'a13', category: 'shopping', emoji: '👕', title: 'Buy Second-Hand Clothing', desc: 'Thrift, swap, or rent clothes instead of buying new fast fashion.', saving: '0.2t CO₂/yr', difficulty: 'easy', color: '#8b5cf6' },
  { id: 'a14', category: 'shopping', emoji: '📱', title: 'Keep Electronics Longer', desc: 'Extend smartphone life by 2 years. Making a new phone creates ~70kg CO₂.', saving: '0.07t CO₂/yr', difficulty: 'easy', color: '#8b5cf6' },
  { id: 'a15', category: 'shopping', emoji: '🧴', title: 'Buy Less Plastic', desc: 'Choose refillable, package-free, or low-packaging alternatives.', saving: '0.1t CO₂/yr', difficulty: 'easy', color: '#8b5cf6' },
  { id: 'a16', category: 'travel', emoji: '🚆', title: 'Train Instead of Fly', desc: 'A train journey produces 6–8x less CO₂ per km than flying. Pick rail for short trips.', saving: '0.8t CO₂/yr', difficulty: 'medium', color: '#f59e0b' },
  { id: 'a17', category: 'travel', emoji: '🏖️', title: 'Staycation', desc: 'Explore local destinations instead of flying abroad for one holiday a year.', saving: '1.5t CO₂/trip', difficulty: 'medium', color: '#f59e0b' },
  { id: 'a18', category: 'travel', emoji: '🌲', title: 'Offset Your Flights', desc: 'Purchase certified carbon offsets for unavoidable flights through Gold Standard projects.', saving: '100% of flight', difficulty: 'easy', color: '#f59e0b' },
];

const CHALLENGES = [
  { id: 'c1', icon: '🥗', title: 'Plant-Based Week', days: 7, desc: 'Go fully plant-based for 7 days. Discover delicious vegan recipes and save ~14kg CO₂!', reward: '🏅 Green Plate Badge + 14kg CO₂ saved' },
  { id: 'c2', icon: '🚰', title: 'Zero Waste Week', days: 7, desc: 'Eliminate single-use plastics for 7 days. Bring reusable bags, bottles, and containers.', reward: '🏅 Zero Hero Badge + 5kg CO₂ saved' },
  { id: 'c3', icon: '🚲', title: 'Car-Free Week', days: 7, desc: 'Get around exclusively by foot, bike, or public transit for a full week.', reward: '🏅 Pedal Power Badge + 20kg CO₂ saved' },
  { id: 'c4', icon: '💡', title: 'Energy Audit Challenge', days: 3, desc: 'Audit your home\'s energy use over 3 days and identify the biggest savings opportunities.', reward: '🏅 Energy Expert Badge' },
  { id: 'c5', icon: '🛍️', title: 'No-Buy Week', days: 7, desc: 'Buy nothing new (except essentials) for 7 days. Repair, borrow, or do without.', reward: '🏅 Minimalist Badge + 8kg CO₂ saved' },
  { id: 'c6', icon: '🌳', title: 'Tree Planting Weekend', days: 2, desc: 'Participate in a local tree-planting event or donate to plant 10 trees this weekend.', reward: '🏅 Forest Friend Badge + 10 trees planted' },
];

const CLIMATE_FACTS = [
  { number: '1.5°C', text: 'is the critical warming limit set by the Paris Agreement to avoid the worst climate impacts.' },
  { number: '420ppm', text: 'CO₂ concentration in the atmosphere today — the highest in 3 million years.' },
  { number: '11 yrs', text: 'is how long we have to cut emissions in half to limit warming to 1.5°C (from 2023).' },
  { number: '2.5B', text: 'trees are cut down annually. Forests absorb 2.6 billion tonnes of CO₂ per year.' },
  { number: '71%', text: 'of global emissions come from just 100 companies. But individual action drives systemic change.' },
  { number: '8%', text: 'of global greenhouse gas emissions come from food waste alone.' },
  { number: '3×', text: 'more likely to experience extreme heat waves in a 2°C world compared to a 1.5°C world.' },
  { number: '20%', text: 'of global emissions come from animal agriculture, more than all transport combined.' },
];

const COUNTRIES = [
  { flag: '🇶🇦', name: 'Qatar', val: 32.6, color: '#ef4444' },
  { flag: '🇺🇸', name: 'United States', val: 14.2, color: '#f97316' },
  { flag: '🇦🇺', name: 'Australia', val: 13.3, color: '#f59e0b' },
  { flag: '🇩🇪', name: 'Germany', val: 7.7, color: '#eab308' },
  { flag: '🇬🇧', name: 'United Kingdom', val: 5.2, color: '#84cc16' },
  { flag: '🇨🇳', name: 'China', val: 7.4, color: '#eab308' },
  { flag: '🇮🇳', name: 'India', val: 1.9, color: '#22c55e' },
  { flag: '🌍', name: 'Global Average', val: 4.7, color: '#10b981' },
];

const IMPACT_ITEMS = [
  { icon: '🥗', title: 'If everyone went vegan', text: 'Global food emissions would drop by 70%, freeing up 75% of agricultural land.' },
  { icon: '☀️', title: 'If all homes used renewables', text: '25% of global emissions would be eliminated overnight.' },
  { icon: '🚗', title: 'If no one drove petrol cars', text: 'Transport emissions would fall by ~60%, improving air quality for millions.' },
  { icon: '✈️', title: 'If frequent flyers flew less', text: 'The top 1% of flyers produce 50% of aviation emissions. Their choices matter most.' },
];

// Emission factors (tonnes CO2 per year)
const EMISSION_FACTORS = {
  transport: {
    carType: { petrol: 1.0, diesel: 0.95, hybrid: 0.5, electric: 0.2, none: 0 },
    carMilesMultiplier: 0.0024, // per weekly mile
    publicTransportPerHour: 0.015,
    cycleOffset: -0.005,
  },
  home: {
    heatingType: { gas: 1.2, oil: 1.5, electric: 0.6, heatpump: 0.3, solar: 0.1 },
    electricityPerKwh: 0.00023, // per monthly kWh -> annual
    homeSize: { small: 0.8, medium: 1.0, large: 1.4 },
    renewable: { no: 1.0, partial: 0.6, yes: 0.1 },
  },
  food: {
    dietType: { vegan: 0.9, vegetarian: 1.2, flexitarian: 1.6, omnivore: 2.1, heavymeat: 3.3 },
    foodWaste: { low: 0, medium: 0.2, high: 0.5 },
    localFood: { always: -0.1, sometimes: 0, never: 0.1 },
  },
  shopping: {
    clothingPerItem: 0.012,
    electronics: { none: 0, one: 0.15, several: 0.4, many: 0.8 },
    shoppingHabit: { minimal: 0.3, average: 0.7, heavy: 1.4 },
    secondHand: { often: -0.2, sometimes: -0.05, never: 0 },
  },
  travel: {
    shortFlightPerFlight: 0.25,
    longFlightPerFlight: 1.5,
    flightClass: { economy: 1.0, business: 2.0, first: 3.0 },
    flightOffset: { always: -0.9, sometimes: -0.4, never: 0 },
  },
};
...
function calcTransport() {
  ...
  const carBase = ef.carType[carType];
  const carMiles = miles * ef.carMilesMultiplier * 52;
  const pt = ptHours * ef.publicTransportPerHour * 52;
  const cyc = cycle * ef.cycleOffset * 52;
  return Math.max(0, carBase + carMiles + pt + cyc);
}
...
function calcHome() {
  ...
  const base = ef.heatingType[heating] * ef.homeSize[size];
  const elec = kwh * ef.electricityPerKwh * 12 * ef.renewable[renew];
  return Math.max(0, base + elec);
}
...
function calcFood() {
  ...
  return Math.max(0, ef.dietType[diet] + ef.foodWaste[waste] + ef.localFood[local]);
}
...
function calcShopping() {
  ...
  const clothTotal = clothing * ef.clothingPerItem * 12;
  return Math.max(0, clothTotal + ef.electronics[elec] + ef.shoppingHabit[habit] + ef.secondHand[sh]);
}
...
function calcTravel() {
  ...
  const ef = EMISSION_FACTORS.travel;
  const multiplier = ef.flightClass[cls];
  const flights = (sf * ef.shortFlightPerFlight + lf * ef.longFlightPerFlight) * multiplier;
  const offsetVal = flights * (offset === 'always' ? 0.9 : offset === 'sometimes' ? 0.4 : 0);
  return Math.max(0, flights - offsetVal);
}
